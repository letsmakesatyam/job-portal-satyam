          ...
          <CarouselContent className="-ml-4">
            {categories.map((cat, i) => (
              <CarouselItem key={i} className="pl-4 basis-1/2 md:basis-1/3 lg:basis-1/4">
                <Button variant="ghost" className="w-full h-32 flex flex-col gap-4 bg-white/5 border border-white/5 hover:border-violet-500/50 hover:bg-zinc-900 rounded-3xl transition-all group">
