          ...
          <div className="flex items-center gap-4">
            {!user ? (
              <div className="flex items-center gap-3">
                ...
                <Link to="/register">
                  <Button className="bg-gradient-to-r from-red-600 to-violet-600 text-white hover:opacity-90">
                    Register
                  </Button>
                </Link>
              </div>
                ...
                <PopoverContent className="w-72 mt-2 p-0 bg-zinc-900 border-white/10 shadow-2xl overflow-hidden">
                  ...
                  <div className="p-2 space-y-1">
                    ...
                    <div
                      ...
                      className="flex items-center gap-3 px-3 py-2 rounded-md text-red-400 hover:bg-red-500/10 transition-all cursor-pointer"
                    >
